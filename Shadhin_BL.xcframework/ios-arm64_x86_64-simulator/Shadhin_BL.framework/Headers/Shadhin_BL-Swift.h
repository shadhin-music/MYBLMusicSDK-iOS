...
#ifndef SHADHIN_BL_SWIFT_H
#define SHADHIN_BL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Shadhin_BL",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface BLRadioView (SWIFT_EXTENSION(Shadhin_BL)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC10Shadhin_BL9ShadhinBL")
...
- (BLRadioView * _Nullable)radioViewWithIsAutoPlay:(BOOL)isAutoPlay SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP10Shadhin_BL19ShadhinCoreNotifier_")
@protocol ShadhinCoreNotifier <NSObject>
- (void)tokenStatusWithToken:(BOOL)isValid error:(NSString * _Nullable)error;
- (void)patchErrorWithError:(NSString * _Nonnull)error;
- (void)amarTuneErrorWithError:(NSString * _Nullable)error;
- (void)rcErrorWithError:(NSString * _Nullable)error;
- (void)shareContentWithRCWithTitle:(NSString * _Nonnull)title image:(NSString * _Nonnull)image rc:(NSString * _Nonnull)code;
